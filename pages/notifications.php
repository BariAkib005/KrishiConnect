...
<section class="section">
    <div class="container">
        <div class="dash-header">
            ...
            <form method="post" action="<?= url('app/actions/notifications_mark_all.php'); ?>"><?= csrf_field('app'); ?>
            ...
            <?php else: ?>
                <?php foreach ($notifications as $n): ?>
                    <div class="notification-card <?= $n['is_read'] ? '' : 'unread'; ?>">
                        ...
                        <form method="post" action="<?= url('app/actions/notification_delete.php'); ?>"><?= csrf_field('app'); ?>
