                        ...
                        <div class="cart-item">
                            ...
                            <div class="cart-info">
                                <div class="cart-info-head">
                                    ...
                                    <form method="post" action="<?= url('app/actions/cart_remove.php'); ?>"><?= csrf_field('app'); ?>
                                ...
                                <div class="cart-info-body">
                                    <form method="post" action="<?= url('app/actions/cart_update.php'); ?>" class="qty-control"><?= csrf_field('app'); ?>
                                        <input type="hidden" name="cart_item_id" value="<?= (int)$item['cart_item_id']; ?>">
