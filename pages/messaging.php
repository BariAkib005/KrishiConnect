        ...
        <div class="message-layout">
            <div class="message-list">
                ...
                <div class="message-start">
                    ...
                    <form method="post" action="<?= url('app/actions/message_send.php'); ?>"><?= csrf_field('app'); ?>
            ...
            <div class="message-chat">
                ...
                <?php else: ?>
                    ...
                    <form class="chat-input" method="post" action="<?= url('app/actions/message_send.php'); ?>"><?= csrf_field('app'); ?>
