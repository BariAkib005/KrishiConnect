    ...
    <section class="auth-right">
        <div class="auth-form">
            ...
            <?php elseif ($error === 'role'): ?>
                <p class="alert">Please choose a valid role.</p>
            ...
            <form method="post" action="<?= url('app/actions/register.php'); ?>">
                ...
                <div class="form-group">
                    ...
                    <p class="form-hint"><i class="fas fa-circle-info"></i> Finance accounts require admin approval before first sign-in.</p>
                </div>
                <div class="form-row">
                    <div class="form-group">
