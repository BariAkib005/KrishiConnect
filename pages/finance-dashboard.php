...
<div class="dashboard-layout">
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            <a href="<?= url('pages/finance-dashboard.php'); ?>" class="active"><i class="fas fa-tachometer-alt"></i> Dashboard</a>
            <a href="<?= url('pages/loan-management.php'); ?>"><i class="fas fa-file-invoice"></i> Loan Applications</a>
            <a href="<?= url('pages/disbursements.php'); ?>"><i class="fas fa-chart-line"></i> Disbursements</a>
