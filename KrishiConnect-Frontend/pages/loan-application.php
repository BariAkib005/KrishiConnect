        ...
        <div class="form-container" style="max-width:800px;margin:0 auto">
            ...
            <form method="post" action="<?= url('app/actions/loan_apply.php'); ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="loan_amount" name="loan_amount" placeholder="Enter amount in Taka" value="<?= htmlspecialchars($old_amount ?? ''); ?>" required>
...
(function(){
    ...
    function computeRange(income){
        if(income < 25000) return [5000,30000];
        if(income >= 25000 && income <= 50000) return [5000,50000];
        if(income >= 50001 && income <= 100000) return [50000,100000];
        return [50000,150000];
    }
