...
<main class="container-fluid px-4 py-4">
    ...
    <section class="card border-0 shadow-sm mb-4">
        <div class="card-header bg-white py-3">
            <h2 class="h5 mb-0">Master Loan Applications</h2>
        </div>
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                    <?php if (!$applications): ?>
                        <tr>
                            <td colspan="8" class="text-center text-secondary py-4">No loan applications found.</td>
                        </tr>
                    <?php endif; ?>
                    <?php foreach ($applications as $application): ?>
                        <tr>
                            ...
                            <td>
                                <span class="badge text-bg-<?= $application['status'] === 'rejected' ? 'danger' : ($application['status'] === 'pending' ? 'warning' : 'success'); ?>">
                                    <?= h(ucwords(str_replace('_', ' ', $application['status']))); ?>
                                </span>
                            </td>
                            <td>
                                <div class="d-flex justify-content-end gap-2">
                                    <a class="btn btn-outline-secondary btn-sm" href="<?= h(url('admin/loan_management.php?loan_id=' . (int)$application['id'])); ?>">
                                        View Details
                                    </a>
